      ...
      <Col style="width: 270px; max-width: 270px;position: absolute;">
        <Card class="stepCard">
          <Steps :current="currentStep" direction="vertical">
            <Step title="变更公示基本信息" content=""></Step>
...
<script>
import correctStep1 from "./editCorrectSteps/correctStep1";
import correctStep2 from "./editCorrectSteps/correctStep2";
import correctStep3 from "./editCorrectSteps/correctStep3";
import correctStep4 from "./editCorrectSteps/correctStep4";
export default {
  name: "correctEdit",
  components: {
    correctStep1,
