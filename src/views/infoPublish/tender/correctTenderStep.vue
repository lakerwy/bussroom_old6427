...
<script>
import correctStep1 from "./correntTenderSteps/correctStep1";
import correctStep2 from "./correntTenderSteps/correctStep2";
import correctStep3 from "./correntTenderSteps/correctStep3";
import correctStep4 from "./correntTenderSteps/correctStep4";
export default {
  name: "correntTenderStep",
  components: {
    correctStep1,
    correctStep2,
    correctStep3,
