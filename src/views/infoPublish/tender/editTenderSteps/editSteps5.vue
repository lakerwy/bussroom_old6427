            ...
            <div class="step-center" v-if="tenderFlag">
              <Card>
                ...
                <Row>
                  ...
                  <Col :span="4" style="margin-left: 10px; margin-top: 6px"
                    ><span>万元</span></Col
                  >
                </Row>
                <div class="center">
...
import { getBidsList, saveTenderBid, saveSectionInfo } from "@/api/publishApi";
export default {
  name: "editSteps5",
  props: {
    currentStep: {
  ...
  methods: {
    ...
    // 获取当前公告关联标段
    getTenderBids() {
      getBidsList(this.$route.query.id).then((res) => {
        if (res.success) {
