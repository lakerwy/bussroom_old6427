<template>
  <div class="prequalificationStep7">
    <div class="inner-side">
      <Card style="padding-bottom: 200px;height:100%;overflow-y: auto;" class="inner-card">
        ...
        <Row>
          <p class="infoTitle">四、资格预审文件的获取</p>
          <div class="infoText">
        ...
        <Row>
          <p class="infoTitle">五、资格预审申请文件的递交</p>
          <div class="infoText">
...
<script>
import {
  saveBuildNotice,prePreView
} from "@/api/publishApi";
export default {
  name: "prequalificationStep7",
  props: {
    currentStep: {
      type: Number,
      default: 6,
  ...
  methods: {
    // 预览
    view() {
      prePreView(this.getStore("addPreId")).then(res => {
        if(res.success) {
