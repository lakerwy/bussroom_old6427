<template>
  <card class="prequalificationDetails2">
    <h1 style="display: inline-block">投标管理</h1>
    <h3 style="display: inline-block; float: right">导出报名表</h3>
