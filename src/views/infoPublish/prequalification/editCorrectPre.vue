...
<script>
import correctStep1 from "./editCorrectPre/correctStep1";
import correctStep2 from "./editCorrectPre/correctStep2";
import correctStep3 from "./editCorrectPre/correctStep3";
import correctStep4 from "./editCorrectPre/correctStep4";
export default {
  name: "editCorrectPre",
  components: {
    correctStep1,
