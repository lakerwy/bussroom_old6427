<template>
  <div class="prequalificationCorrect">
...
<script>
import correctStep1 from "./correctSteps/correctStep1";
import correctStep2 from "./correctSteps/correctStep2";
import correctStep3 from "./correctSteps/correctStep3";
import correctStep4 from "./correctSteps/correctStep4";
export default {
  name: "prequalificationCorrect",
  components: {
    correctStep1,
    correctStep2,
    correctStep3,
