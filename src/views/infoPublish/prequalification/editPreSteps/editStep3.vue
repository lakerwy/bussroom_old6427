<template>
  <div class="prequalificationStep3">
        ...
        <Row>
          <Col :span="12">
            <FormItem prop="agentAddress" label="招标人地址">
              <Input v-model="formItem.agentAddress" disabled :maxlength="500" />
            </FormItem>
          </Col>
          <Col :span="12">
          ...
          <Row>
            <Col :span="12">
              <FormItem prop="organAddress" label="招标代理机构地址">
                <Input v-model="formItem.organAddress" :maxlength="500" disabled/>
              </FormItem>
            </Col>
            <Col :span="12">
