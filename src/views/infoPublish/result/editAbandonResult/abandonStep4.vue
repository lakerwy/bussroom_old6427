<template>
  <div class="symptomStep4">
    <Card>
      ...
      <div class="button">
        <Button size="large" @click="index">发布中标结果公告</Button>
...
export default {
  ...
  activated() {
    if (this.getStore("editAbandonResult")) {
      this.removeStore("editAbandonResult");
      ...
      if (
        ...
        this.$Modal.confirm({
          ...
          onOk: () => {
            ...
            this.$store.commit("removeTag", "abandonResult");
            this.$store.commit("closePage", "abandonResult");
          },
        });
      } else {
        this.setStore('addResultClickFlag', true)
