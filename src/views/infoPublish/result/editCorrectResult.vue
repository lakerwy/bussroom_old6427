...
<script>
import correctStep1 from "./editCorrectResult/correctStep1";
import correctStep2 from "./editCorrectResult/correctStep2";
import correctStep3 from "./editCorrectResult/correctStep3";
import correctStep4 from "./editCorrectResult/correctStep4";
export default {
